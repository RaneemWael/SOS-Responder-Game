...
public class Citizen implements Rescuable,Simulatable{
	...
	public String getStateName() {
		if (getState()==CitizenState.SAFE)
			return "Safe";
		else if (getState()==CitizenState.IN_TROUBLE)
			return "In trouble";
		else if (getState()==CitizenState.RESCUED)
			return "Rescued";
		else if (getState()==CitizenState.DECEASED)
			return "Deceased";
		return null;
	}
